...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    float elapsed_sec = (stop_time-start_time)*(1.0)/(125000000.0);
    float num_mega_bytes = 32*2048/8/1000;
    throughput = num_mega_bytes/elapsed_sec;
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Emma Kaufman - Custom Peripheral Demonstration\n\r");
